...
import org.knime.semanticweb.nodes.connector.sparqlendpoint.SPARQLEndpointModel;
...
import org.knime.semanticweb.services.impl.VirtuosoEndpointService;

/**
 * @author Lara Gorini
 *
 */
public class VirtuosoEndpointModel extends SPARQLEndpointModel {
	...
	protected SemanticWebPortObjectSpec createSpec() throws InvalidSettingsException {
		return new SemanticWebPortObjectSpec("virtuoso");
	}
}
